# -*- coding: utf-8 -*-
"""CC_C_Num_testing.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1mNLWHqIOSsTOW2hev-JB_gNnYSSMTsIX

This programming project is to test if an input graph $H = (V,E)$ has cop number $k$ for graphs we know have attacking cop number at least $2k$. At least for now the goal will be to check in the case that $k = 3$ where our graphs H are G^2 - E for a $(3,9)$-cage $G$. Our results are the following.
